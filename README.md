...
*  You'll nned to create some files (eg. \__init\__.py, pyproject.toml, LICENSE, README) and directory structure (src, tests) and other files will be created duting the packagiing process (*.egg-info, *.tar.gz, *.whl)
